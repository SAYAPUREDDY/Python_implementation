...
def usage():
    print("Word and Line counter by Harshini Praveen Kumar, Uni Potsdam, 2023")
    ...
    print("     -lc   - counting lines and chars")
    print("     -lc   - counting lines and chars")
    print("     -cw   - counting chars and words")
    print("     -lw   - counting lines and words")
    print("     -lcw   - counting lines chars and words")
    exit()
